            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <select name="countryCode" class="form-control input-group-text" id="">
                    ...
                    <input type="tel" class="form-control col-md" placeholder="23-456-7891" name="phone" required>
                    <div class="valid-feedback">
                        Good!
                    </div>
                    <div class="invalid-feedback">
            ...
            <div class="form-row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback">
                            Password should be the same as the one entered above!
                        </div>
                    </div>
                </div>
            </div>
